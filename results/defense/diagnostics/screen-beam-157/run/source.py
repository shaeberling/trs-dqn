...
def select_beam(nodes, limit, rng, *, mandatory=None):
    ...
    # Preserve at most one state for each observed cell, except the exact
    # verified source path. Hidden emulator bytes never enter a rank/key.
...
def verify_discovery(env, seed, source_frames, source_actions, source_rewards,
                     anchor_saved, path, expected, output):
                    ...
                    for command in COMMANDS:
                        ...
                        if progress:
                            ...
                            verification = verify_discovery(
                                ...
                                source_rewards, anchor_saved, path, outcome, args.output)
