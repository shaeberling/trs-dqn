...
root = Path('results/defense/training/imagination-boundary-comparison-01')
root.mkdir(exist_ok=False)
report = {}
for arm, name in [('uniform', 'defense-imagination-uniform-02'), ('focused', 'defense-imagination-boundary-03')]:
...
report['limitations'] = 'Frozen-world calibration; reused complete boot games, not fresh success estimates; no online feedback yet; no shared-best replacement.'
