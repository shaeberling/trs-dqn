...
Current standard-policy best: **10,200 points**, all **2,495** neural actions
verified after reloading the frozen model. Ten complete validation games:
mean **7,019**, median **7,090**, all stage 1. This comes from the own-experience
curriculum continuation with longer rollouts and ship-loss learning boundaries,
at counter **7,039,744**, with ordinary
